...
def create_config(config_file_env, config_file_exp):
    ...
    cfg['pretext_model_instance'] = os.path.join(pretext_dir, 'instance_model.pth.tar')
    cfg['pretext_model_group'] = os.path.join(pretext_dir, 'group_model.pth.tar')
