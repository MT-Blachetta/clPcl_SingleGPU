# clPcl_pretextTask
This project introduces a new advanced pretext task integrated to wvangansbeke SCAN method for unsupervised semantic image clustering. (https://github.com/wvangansbeke/Unsupervised-Classification) It's called clPcl meaning cross level prototypical contrastive learning.

<img scr="images/illustration.jpg" />
...
```shell
python pcl_cld.py --config_env configs/your_env.yml --config_exp configs/pretext/clPcl_stl10.yml
...
If you want to use the new clPcl pretext task with the stl-10 dataset run this command
```shell
python pcl_cld.py --config_env configs/your_env.yml --config_exp configs/pretext/clPcl_stl10.yml
```
